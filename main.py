...
# Initial products list with the 3 new products added (Task 1)
products = [
    ...
    {"id": 3, "name": "Water Bottle", "price": 599, "category": "Lifestyle", "in_stock": True},
    {"id": 4, "name": "Pen Set", "price": 49, "category": "Stationery", "in_stock": True},
    # Task 1: New products added
...
def get_by_category(category_name: str):
    # Using case-insensitive match for category to be user-friendly
